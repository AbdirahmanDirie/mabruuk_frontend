...
import {useAddCategoriesMutation, useGetCategoriesQuery, useUpdateCategoryMutation} from '../services/categoryApi'
import {
    Card,
    CardHeader,
    Input,
...
const Category = () => {
    ...
    const [addCategories, {isError, error }] = useAddCategoriesMutation();
  ...
  const OnSubmit = async (e) => {
    ...
    try {
        ...
        const name = category;
      await addCategories({token, name}).unwrap()
      setCategory('');
      handleOpen()
  ...
  const EditOnSubmit = async (e) => {
    ...
    try {
        ...
        const name = viewData;
        const id = catId;
      await updateCategory({token, id, name}).unwrap();
      setViewData('');
      setCatdId('');
      handleEditOpen()
  ...
  return (
    <div className='bg-[#EDF0F5] h-[100vh] px-5 py-5'>
        ...
        <div className="">
          <DialogHeader className='text-[#489EE7]'>Add Category Form</DialogHeader>
...
<div className='flex flex-col space-y-2'>
    ...
    className='bg-white border-2 border-gray-300  outline-none rounded-[5px] h-[40px] px-2'/> 
        ...
        <div className="">
          <DialogHeader className='text-[#489EE7]'>Edit Category Form</DialogHeader>
          {/* <XMarkIcon className="mr-3 h-5 w-5" onClick={handleOpen} /> */}
        </div>
        <DialogBody className=''>
